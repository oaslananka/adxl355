...
- Added C++ ODR configuration, an installed no-exception `Status`/`Result<T>` target, a thin Arduino SPI adapter, hash-locked PlatformIO tooling, and a required Arduino Uno package/compile fixture.
